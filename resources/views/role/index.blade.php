            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a href="{{url('role/create')}}" class="btn btn-primary J_menuItem">新增</a>
                        </div>
                               ...
                               @foreach($list as $v)
                                <tr class="gradeC">
                                    ...
                                    <td>
                                      ...
                                      <span class="label label-success">{{$jurisdiction}}</span>
                                      @endforeach
                                    </td>
                                    ...
                                    <td class="center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="divider"></li>
                                                <li><a href="javascript:;" id="{{$v->id}}" class="delete" url="{{url('role/'.$v->id)}}">删除</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
