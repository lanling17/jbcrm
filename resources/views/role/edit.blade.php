            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action={{url('role/'.$info['id'])}} class="form-horizontal m-t" id="signupForm" method="POST" enctype="multipart/form-data">
                          @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  ...
                                  <div class="checkbox checkbox-success checkbox-inline">
                                     <input type="checkbox" id="inlineCheckbox{{$juri->id}}" value="{{$juri->id}}" name="juri_ids[]" {{in_array($juri->id,$info['jurisdiction']) ? 'checked' : ''}}>
