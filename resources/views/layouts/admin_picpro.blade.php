 <!-- 图片裁剪 -->
    ...
    <script src="{{asset('hplus/js/iscroll-zoom.js')}}"></script>
    <script src="{{asset('hplus/js/hammer.js')}}"></script>
    <script src="{{asset('hplus/js/lrz.all.bundle.js')}}"></script>
    <script src="{{asset('hplus/js/jquery.photoClip.js')}}"></script>
