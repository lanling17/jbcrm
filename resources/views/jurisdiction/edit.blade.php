            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action={{url('jurisdiction/'.$info['id'])}} class="form-horizontal m-t" method="POST" enctype="multipart/form-data">
                          @csrf
                          <input type="hidden" name="_method" value="put"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="slug" class="form-control" type="text" value="{{$info['slug']}}">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" name="http_method">
                                      @foreach(config('hint.HTTP') as $v)
                                       <option value={{$v}} {{ $info['http_method'] == $v ? 'selected' : '' }}>{{$v}}</option>
                                       @endforeach
                                    </select>
                                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 这里写点提示的内容</span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                     <textarea style="width: 100%;height: 100px;resize: none;" name="http_path">{{$info['http_path']}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
